...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView Icirculo, Itriangulo, Icuadro, Icubo;
    Button bCalcular;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Icirculo = (ImageView) findViewById(R.id.Icirculo);
        Itriangulo = (ImageView) findViewById(R.id.Itriangulo);
        Icuadro = (ImageView) findViewById(R.id.Icuadro);
        Icubo = (ImageView) findViewById(R.id.Icubo);
        ...
        switch (view.getId()){
            case R.id.rbCirculo:
                if (((RadioButton) view).isChecked()){
                    ...
                    Icirculo.setVisibility(View.VISIBLE);
                    Itriangulo.setVisibility(View.GONE);
                    Icuadro.setVisibility(View.GONE);
                    Icubo.setVisibility(View.GONE);
            ...
            case R.id.rbCuadro:
                if (((RadioButton) view).isChecked()){
                    ...
                    Icirculo.setVisibility(View.GONE);
                    Itriangulo.setVisibility(View.GONE);
                    Icuadro.setVisibility(View.VISIBLE);
                    Icubo.setVisibility(View.GONE);
                }
                break;
            case R.id.rbTriangulo:
                if (((RadioButton) view).isChecked()){
                    ...
                    Icirculo.setVisibility(View.GONE);
                    Itriangulo.setVisibility(View.VISIBLE);
                    Icuadro.setVisibility(View.GONE);
                    Icubo.setVisibility(View.GONE);
                }
                break;
            case R.id.rbCubo:
                if (((RadioButton) view).isChecked()){
                    ...
                    Itriangulo.setVisibility(View.GONE);
                    Icuadro.setVisibility(View.GONE);
                    Icubo.setVisibility(View.VISIBLE);
                }
                break;
        }
    }
